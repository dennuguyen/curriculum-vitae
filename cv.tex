...
\CVSECTION{Work Experience}
    ...
    \CVHEADING{UNSW}{}
        \CVSUBHEADING{DESN1000 Casual Academic}{Feb 2023 -- Current}
        \startitemize
            \item Prepared lesson plans covering Arduino, distance sensing, DC and servo motor control, and compass sensing for first-semester engineering students with current satisfaction rate of 95\%.
            \item Performed impromptu lessons under unforeseen circumstances such as class merging.
        \stopitemize

        \CVSUBHEADING{MTRN4231 Casual Academic}{May 2022 -- Current}
        \startitemize
            \item Advised development of course curriculum and administration.
        \stopitemize

        \CVSUBHEADING{MTRN3100 Head Demonstrator}{Dec 2022 -- Current}
        \startitemize
            \item Advised development of course curriculum.
            \item Prototyped a simple mobile robot with localisation, mapping, and autonomous navigation capabilities.
            \item Planned practical lab assessments covering Arduino, PID controllers, filters, odometry, kinematics, autonomous mapping, and path planning.
        \stopitemize

        \CVSUBHEADING{MTRN2500 Head Demonstrator}{Jun 2022 -- Current}
        \startitemize
            \item Advised course restructuring and administrative matters.
            \item Designed C++ lab and assignment content covering C++ basics, classes, memory management, I/O, STL, templates, and polymorphism.
            \item Established processes to standardise marking procedures, conducting labs, student assessment submissions, and managing classes.
            \item Developed a sandboxed autotester for integration with doctest (C++ testing framework).
        \stopitemize

        \CVSUBHEADING{MTRN4110 Casual Academic}{May 2022 -- Aug 2022}
        \startitemize
            \item Prepared lesson plans and materials for demonstrations covering Webots.
        \stopitemize

        \CVSUBHEADING{MTRN2500 Casual Academic}{Sep 2021 -- Dec 2021}
        \startitemize
            \item Prepared lesson plans and materials for demonstrations and help sessions covering C++, Webots, OOP, UML class diagrams, and MATLAB.
            \item Automated administrative processes using Python for attendance-taking and sorting student groups.
            \item Adapted teaching style every week to match student needs and preferences e.g. creating notes, cheat sheets, and exercises; and achieved satisfaction rate of 95\% from 24 students.
        \stopitemize
    ...
    \CVHEADING{Sperospace}{}
        ...
        \startitemize
            ...
            \item Designed an end effector rated for technology readiness level 3 for use in space applications.
        \stopitemize
...
\CVSECTION{Project Experience}
    ...
    \CVHEADING{UNSW Competitive Robotics Group}{}
        ...
        \startitemize
            \item Co-wrote accepted whitepaper for UAV swarm network architecture with USV ground station.
...
\CVSECTION{Extracurricular}
    \CVHEADING{CSESoc Peer Mentoring}{}
        ...
        \startitemize
            \item Assisting student transition into university life and strategising their degree plan.
            \item Participated in CSESoc's Lab0 event to help students set-up their development environments which included SSH, VSCode, and C build tools.
        \stopitemize
