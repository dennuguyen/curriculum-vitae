...
\CVSECTION{Summary}
    ...
    Efficient, methodical, and strongly organised project manager of Offworld Robotics with 1+ year experience. Highly proficient software developer and C++ scholar. Self-taught mechanical engineer. Consistently striving for peak excellence within responsibilities and interests.
    \blank[big]
...
\CVSECTION{Education}
    ...
    \CVHEADING{University of New South Wales}{Feb 2018 -- Dec 2023}
        ...
        \startitemize
            \item Cumulative WAM of 82.138.
            \item Notable courses: ENGG3600 (94), MATH2019 (93), MMAN2130 (90).
        \stopitemize
...
\CVSECTION{Work Experience}
    ...
    \CVHEADING{UNSW}{}
        \CVSUBHEADING{MTRN4110 Casual Academic}{May 2022 -- Current}
        \startitemize
            \item Prepared lesson plans and materials for demonstrations.
        \stopitemize

        \CVSUBHEADING{MTRN2500 Casual Academic}{Sep 2021 -- Current}
        \startitemize
...
\CVSECTION{Project Experience}
    ...
    \CVHEADING{UNSW Competitive Robotics Group}{}
        ...
        \startitemize
            \item Wrote accepted whitepaper for UAV swarm network architecture with USV ground station.
...
\CVSECTION{Extracurricular}
    ...
    \CVHEADING{CSESoc Peer Mentoring}{Feb 2022 -- May 2022}
        \CVSUBHEADING{Peer Mentor}{}
        \startitemize
...
\CVSECTION{Volunteer Experience}
    ...
    \CVHEADING{Engineering World Health Summer Institute}{}
        ...
        \startitemize
            \item Trained in a student volunteer program in Cambodia with acquired skills in soldering, mechanical and electrical repairs of biomedical equipment.
            \item Repaired and returned to service twenty-seven hospital equipment in a four-week placement at a rural hospital.
            \item Built an AC-to-DC rectifier to extensively test electrical circuits of biomedical equipment.
        \stopitemize
...
\CVSECTION{Technical Skills}
    ...
    \startmixedcolumns[n=2, balance=yes]
        ...
        \CVHEADING{Robotics}{}
        \startitemize
            \item ROS, RViz, Gazebo, URDF, SDF.
            \item Webots.
            \item Robotic software architectures.
            \item State diagrams.
        \stopitemize
        ...
        \startitemize
            \item C++20.
            \item Catch2, GoogleTest.
            \item GoogleBenchmark.
            \item Python.
